# Contributing to oscal_assessment_plan

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
oscal_assessment_plan. These guidelines are not strict rules.
...
The oscal_assessment_plan team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the oscal_assessment_plan technical leads
...
[issues]: https://github.com/lmodel/oscal_assessment_plan/issues/
[pulls]: https://github.com/lmodel/oscal_assessment_plan/pulls/
